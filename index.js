...
// =====================================
const settings = {
  name: "Sanzxcode Api's",
  description: "Sanzxcode Api is a simple and lightweight REST API built with Next.js, designed to provide easy access to various web functionalities.", 
  apiSettings: {
    creator: "Sanzxcode",
    apikey: ["Sanzz"]
  },
    linkWhatsapp: "https://whatsapp.com/channel/0029VbBXcHvHVvTgp3bRsY0C",
...
app.use((req, res, next) => {
  ...
  res.json = function (data) {
    if (data && typeof data === 'object') {
      const responseData = {
        status: data.status,
        creator: settings.apiSettings.creator || "Created Using Sanzxcode",
        ...data
      };
